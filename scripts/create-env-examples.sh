...
# Script to create .env.example files for all services
# Based on docs/configuration/environment-variables.md

set -e

echo "📝 Creating .env.example files for all services..."
...
# User Service
cat > microservices/user-service/.env.example << 'EOF'
# Application
NODE_ENV=development
PORT=3002
...
# Device Service
cat > microservices/device-service/.env.example << 'EOF'
# Application
NODE_ENV=development
PORT=3003
...
# Telemetry Service
cat > microservices/telemetry-service/.env.example << 'EOF'
# Application
NODE_ENV=development
PORT=3004
...
# Alert Service
cat > microservices/alert-service/.env.example << 'EOF'
# Application
NODE_ENV=development
PORT=3005
...
# Location Service
cat > microservices/location-service/.env.example << 'EOF'
# Application
NODE_ENV=development
PORT=3006
...
# Billing Service
cat > microservices/billing-service/.env.example << 'EOF'
# Application
NODE_ENV=development
PORT=3007
...
# Integration Service
cat > microservices/integration-service/.env.example << 'EOF'
# Application
NODE_ENV=development
PORT=3008
...
# Dispatcher Service
cat > microservices/dispatcher-service/.env.example << 'EOF'
# Application
NODE_ENV=development
PORT=3009
...
# Analytics Service
cat > microservices/analytics-service/.env.example << 'EOF'
# Application
NODE_ENV=development
PORT=3010
...
cat > microservices/ai-prediction-service/.env.example << 'EOF'
# Application
NODE_ENV=development
PORT=3011
...
cat > microservices/organization-service/.env.example << 'EOF'
# Application
NODE_ENV=development
PORT=3012
...
# Frontend apps
cat > frontend/apps/guardian-app/.env.example << 'EOF'
# Application
...
cat > frontend/apps/dispatcher-app/.env.example << 'EOF'
# Application
VITE_API_URL=http://localhost:3000/api/v1
VITE_WS_URL=ws://localhost:3000
...
cat > frontend/apps/admin-app/.env.example << 'EOF'
# Application
VITE_API_URL=http://localhost:3000/api/v1
VITE_WS_URL=ws://localhost:3000
...
cat > frontend/apps/landing-app/.env.example << 'EOF'
# Application
VITE_API_URL=http://localhost:3000/api/v1
...
echo "✅ All .env.example files created successfully!"
