...
export const useLocationStore = defineStore('location', () => {
  ...
  async function fetchLatestLocation(wardId: string) {
    ...
    try {
      ...
      if (location) {
        ...
        console.log(`Location fetched for ward ${wardId}:`, location);
      } else {
        console.warn(`No location data for ward ${wardId}`);
      }
      return location;
    } catch (error: any) {
  ...
  async function fetchLocationHistory(
    ...
    try {
      ...
      console.log(`Location history fetched for ward ${wardId}:`, response);
      return response;
    } catch (error: any) {
